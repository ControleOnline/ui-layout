...
const styles = StyleSheet.create({
  ...
  duplicateDropdownWrap: {
    gap: 8,
  },
  duplicateDropdownButton: {
    minHeight: 46,
    borderRadius: 12,
    borderWidth: 1,
    borderColor: '#cccccc',
  ...
  duplicateDropdownButtonActive: {
    borderColor: '#334155',
  },
  duplicateDropdownButtonText: {
    flex: 1,
    fontSize: 14,
    fontWeight: '700',
    color: '#1A1A1A',
  },
  duplicateDropdownPlaceholder: {
    color: '#94A3B8',
  },
  duplicateDropdownList: {
    borderRadius: 12,
    borderWidth: 1,
    borderColor: '#D7E1EC',
    backgroundColor: '#FFFFFF',
  ...
  editorControlCardFooterSliderAligned: {
    paddingRight: 40,
  },
  toneEditorInline: {
    flex: 1,
  ...
  toneEditorThumbDisabled: {
    borderColor: '#94A3B8',
  },
  toneEditorPreviewButton: {
    width: 24,
    height: 24,
    borderRadius: 999,
    borderWidth: 1,
